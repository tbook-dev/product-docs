> For the complete documentation index, see [llms.txt](https://docs.tbook.com/tbook/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.tbook.com/tbook/projects/how-to-launch-an-sbt-on-sui/before-you-start.md).
...
<summary><strong>SBT Name</strong></summary>
...
<summary><strong>SBT Description</strong></summary>
...
<summary><strong>Telegram Group / Channel Tasks</strong></summary>
...
<summary><strong>On-chain Credential Verification (Pro)</strong></summary>
...
<summary><strong>Custom Off-chain Credential Verification (Pro)</strong></summary>
