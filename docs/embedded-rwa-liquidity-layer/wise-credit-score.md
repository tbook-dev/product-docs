...
The [WISE Score](https://engage.tbook.com/wise) evaluates reputation in Web3. It converts user activity—financial, social, and behavioral—into a single, verifiable score that reflects impact and value created across ecosystems.

![](/img/syfyDvkHYCKJxxvc3Ylk.png)
